...
function Signup() {
  ...
  const [form, setForm] = useState({ name: "", email: "", password: "", linkedInProfile: "" });
  const [showPassword, setShowPassword] = useState(false);
  const [focusedField, setFocusedField] = useState(null); // Fixed: Removed <string | null>

  const handleSignup = async (e) => { // Fixed: Removed : React.FormEvent
    e.preventDefault();
    
    // Assignment Requirement: Basic validation for LinkedIn URL
    if (!form.linkedInProfile) {
      return alert("LinkedIn Profile URL is mandatory!");
    }
  ...
  return (
    <div className="w-full max-w-2xl mx-auto relative z-10">
      {/* Floating Particles Background from your original design */}
      {[...Array(8)].map((_, i) => (
        <motion.div
          key={i}
        ...
        <div className="relative bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 border border-white/40">
          <div className="flex flex-col items-center justify-center mb-8">
            <div className="relative mb-4">
              <motion.div className="absolute inset-0 -m-3 animate-spin-slow">
              ...
              <motion.div 
                ...
                whileHover={{ rotate: [0, -10, 10, -10, 0] }} // This is the "shake" logic
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            <div>
              ...
              <div className="relative bg-white rounded-xl">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-pink-300 outline-none bg-gradient-to-r from-pink-50/50 to-purple-50/50"
              ...
              <div>
                ...
                <div className="relative bg-white rounded-xl">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-purple-300 outline-none bg-gradient-to-r from-purple-50/50 to-blue-50/50"
              ...
              <div>
                ...
                <div className="relative bg-white rounded-xl">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-4 rounded-xl border-2 border-gray-200 focus:border-blue-300 outline-none bg-gradient-to-r from-blue-50/50 to-cyan-50/50"
            ...
            <div>
              <label className="block text-sm text-gray-700 mb-2 font-medium">LinkedIn URL (Mandatory)</label>
              <div className="relative bg-white rounded-xl">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-blue-300 outline-none bg-gradient-to-r from-blue-50/50 to-purple-50/50"
                  onChange={(e) => setForm({ ...form, linkedInProfile: e.target.value })}
                />
              </div>
            </div>

            <button type="submit" className="w-full relative overflow-hidden rounded-xl py-4 group shadow-xl">
          ...
          <p className="text-center pt-6 text-sm text-gray-600 font-medium">
            Already have an account? <a href="/" className="bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-purple-500 font-bold hover:underline">Login here</a>
          </p>
        </div>
      </motion.div>
    </div>
